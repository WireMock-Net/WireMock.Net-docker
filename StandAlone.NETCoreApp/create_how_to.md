...
``` cmd
docker tag sheyenrath/wiremock.net-nanoserver-1809:latest sheyenrath/wiremock.net-nanoserver-1809:1.8.13-preview-01
```
...
docker push sheyenrath/wiremock.net-nanoserver-1809:1.8.13-preview-01
```