...
``` cmd
docker tag sheyenrath/wiremock.net-nanoserver-1809:latest sheyenrath/wiremock.net-nanoserver-1809:1.5.13
```
...
docker push sheyenrath/wiremock.net-nanoserver-1809:1.5.13
```