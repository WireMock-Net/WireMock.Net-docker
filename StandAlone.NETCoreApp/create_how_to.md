...
``` cmd
docker tag sheyenrath/wiremock.net-nanoserver-1809:latest sheyenrath/wiremock.net-nanoserver-1809:1.6.3
```
...
docker push sheyenrath/wiremock.net-nanoserver-1809:1.6.3
```